...
[![Release](https://img.shields.io/badge/Release-v1.0.10-emerald?style=flat-square)](https://github.com/memelandfaner/linux-mint-safeer-browser/releases/tag/v1.0.10)
...
[![Package](https://img.shields.io/badge/Package-.deb_(all)-cyan?style=flat-square)](https://github.com/memelandfaner/linux-mint-safeer-browser/releases/tag/v1.0.10)
...
Najnovejšo različico prenesite s strani [GitHub Releases v1.0.10](https://github.com/memelandfaner/linux-mint-safeer-browser/releases/tag/v1.0.10) ali namestite:

```bash
# Namestitev z apt:
sudo apt install ./safeer-browser_1.0.10_all.deb
```
...
- Podrobnosti in obseg preverjanja: [opombe izdaje](RELEASE_NOTES_1.0.10.md).
...
- **Prenosi in izdaje**: [GitHub Releases v1.0.10](https://github.com/memelandfaner/linux-mint-safeer-browser/releases/tag/v1.0.10)
