...
[![Release](https://img.shields.io/badge/Release-v1.0.12-emerald?style=flat-square)](https://github.com/memelandfaner/linux-mint-safeer-browser/releases/tag/v1.0.12)
...
[![Package](https://img.shields.io/badge/Package-.deb_(all)-cyan?style=flat-square)](https://github.com/memelandfaner/linux-mint-safeer-browser/releases/tag/v1.0.12)
...
Najnovejšo različico prenesite s strani [GitHub Releases v1.0.12](https://github.com/memelandfaner/linux-mint-safeer-browser/releases/tag/v1.0.12) ali namestite:

```bash
# Namestitev z apt:
sudo apt install ./safeer-browser_1.0.12_all.deb
```
...
- **Prenosi in izdaje**: [GitHub Releases v1.0.12](https://github.com/memelandfaner/linux-mint-safeer-browser/releases/tag/v1.0.12)
